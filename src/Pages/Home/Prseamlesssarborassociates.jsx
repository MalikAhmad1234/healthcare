...
const Prseamlesssarborassociates = () => {
  const bannerStyles = { 
  ...
  return (
    <>
      ...
      <Banner1 heading={'Seamless & Impactful'}
        description={'A Seamless and Impactful Alternative to Arbor Associates'}
        meta={'EmpowerCare is revolutionizing the way healthcare professionals find fulfilling job opportunities. We go beyond the traditional healthcare staffing agency by offering a seamless and impactful experience that puts your needs and aspirations first.'}
        bannerImg={bannerImg}
        styles={bannerStyles}
...
export default Prseamlesssarborassociates