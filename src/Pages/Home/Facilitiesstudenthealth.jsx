import FacilitiesApproach from "../../Components/FacilitiesApproach/FacilitiesApproach"
...
import bannerImg from '../../Assets/stdbnrimg.png';
    ...
    <>
        ...
        <TrustedPartner
         ...
         anchor={false}
          ...
          heading2={' TRUSTED'}
           heading3={'PARTNER'} 
           description1={'EmpowerCare is your trusted partner for healthcare staffing solutions tailored to educational institutions, colleges, and universities. We understand the critical role that student health plays in academic success and campus well-being. '} 
           description2={'Our extensive network of pre-screened, highly skilled healthcare professionals, including nurses, health screeners, CNAs, and non-clinical staff, ensures you have the right talent to create a thriving '}

           btn={<div className="sec-btns">
            <Link to='/about/contactus' className="learn-btn">
        ...
        button={<div className="bottom-btn">
            <Link to="/post-job" className="signup">
                <span>Post Job</span>
            </Link>
        </div>}
        />
        ...
        />
        <StaffingServices
         greenheading ={'OFFERS A RANGE OF '}
         heading={'EDUCATIONAL HEALTHCARE STAFFING SERVICES'}
          ...
          option3= {'Contract Staffing for University Wellness Programs'}
          option4= {'On-campus Clinic Staffing Solutions'}
          option5= {'Student Health Education and Outreach Specialists'}
        ...
        blackheading={'EEnhance Student '}
        whiteheading2={'Health'}
       ...
       endtext = {"To get this special offer, contact us before [counting down 5 hrs from the time]."}
       btn ={<div className="bottom-btns-row">   
        <Link to="/post-job" className="signup-btn">
            <span>Post Job</span>
        </Link>
    </div>} />
       ...
       description1 ={'Reduced time-to-fill for open positions'}
       description2 ={'Lower turnover rates and improved staff retention'}
       ...
       description4 = {'More time to focus on core academic objectives'}
        ...
        faq_head2 = {'What types of healthcare professionals can EmpowerCare provide to educational settings?'}
