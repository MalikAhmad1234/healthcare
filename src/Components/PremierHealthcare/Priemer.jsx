                ...
                <div className="priemer-wrapper">
                    ...
                    <div className="container">
                        <div className="top-content">
                            ...
                            <p className="description">Seize this rare opportunity to join our prestigious network of Premier Healthcare Professionals within the next 5 days. Gain access to top-tier healthcare jobs, unparalleled support, and career-accelerating benefits. Here is what awaits you:</p>
                        </div>
                        <div className="row">
                            <Carousel
