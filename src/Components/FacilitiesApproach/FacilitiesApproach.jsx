...
const FacilitiesApproach = ({heading1,description1,heading2,description2,heading3,description3,heading4,description4,heading5,description5,link1,link2,link3,link4,link5,button}) => {
...
export default FacilitiesApproach